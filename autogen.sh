...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tgl to login script."
...
# the current dir:
if   test x${GTLANG_tgl} = x ; then
	echo "WARNING: The variable \${GTLANG_tgl} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tgl} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tgl} has the value:"
	echo "  ${GTLANG_tgl}"
