...
This directory contains source files for the Tagalog language morphology
...
-   <https://giellalt.uit.no/lang/tgl/index.html> (analyser)
...
The Tagalog language sources can be acquired using [giella SVN
